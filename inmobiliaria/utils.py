...
import json
import logging
from usuario.models import Dispositivo, Usuario  # 🔹 Usa tu modelo Usuario
...
class NotificacionService:
    ...
    @staticmethod
    def enviar_a_agentes(titulo, mensaje, data_extra=None):
        """Enviar notificación a todos los agentes"""
        return NotificacionService.enviar_a_grupo('agente', titulo, mensaje, data_extra)
